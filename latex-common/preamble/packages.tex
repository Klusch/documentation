...
\input{\commonpath/preamble/packages-tikzpgf.tex}
...
\input{\commonpath/preamble/fix-pgfplots.tex} % fix bug in pgfplots with \directlua
...
\usepackage{\commonpath/mirror-sty/lastpackage}
