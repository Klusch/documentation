...
\input{\commonpath/preamble/style-siunitx.tex}
...
\input{\commonpath/preamble/style-pgfplots.tex}
...
\input{\commonpath/preamble/style-biblatex.tex}
% modifications for an alpha style
\input{\commonpath/preamble/style-biblatex-alpha.tex}
...
\input{\commonpath/preamble/style-caption.tex}

% Style of figure placement with floatrow
\input{\commonpath/preamble/style-floatrow.tex}
...
\input{\commonpath/preamble/style-index.tex}
\input{\commonpath/preamble/style-glossaries.tex}
...
\input{\commonpath/preamble/style-listings.tex}
...
\IfPackageLoaded{geometry}{%
  \input{\commonpath/preamble/style-geometry.tex}
} % Endif
...
\input{\commonpath/preamble/style-scrpage2.tex}
...
\input{\commonpath/preamble/style-titlesec.tex}
...
\input{\commonpath/preamble/style-titletoc.tex}
...
\input{\commonpath/preamble/style-hyperref.tex}
...
\input{\commonpath/preamble/style-references.tex}
...
\input{\commonpath/preamble/fix-tabu-onlyamsmath.tex}

% fix Problem with onlyamsmath active $ char 
% together with the tikz package
\input{\commonpath/preamble/fix-tikz-onlyamsmath.tex}


% fix problems with framed and marginnote
\input{\commonpath/preamble/fix-framed-marginnote.tex}
